...
-- CreateIndex
CREATE UNIQUE INDEX "Category_blogId_name_key" ON "Category"("blogId", "name");
...
-- AddForeignKey
ALTER TABLE "RoleHistory" ADD CONSTRAINT "RoleHistory_changedById_fkey" FOREIGN KEY ("changedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
